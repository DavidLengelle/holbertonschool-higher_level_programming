#!/usr/bin/python3
"""Secure a Flask API with basic auth, JWT tokens and role checks"""
...
def verify_password(username, password):
    """Check a username and password for basic authentication"""
...
@jwt_required()
def jwt_protected():
    """Return a message when a valid JWT token is provided"""
...
def handle_invalid_token_error(err):
    """Return 401 when the token is invalid"""
...
def handle_expired_token_error(err):
    """Return 401 when the token has expired"""
